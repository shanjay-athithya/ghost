...
class _TimeZoneConverterScreenState extends State<TimeZoneConverterScreen> {
  ...
  String convertTime() {
    ...
    // Convert the offset difference to Duration
    final offsetDifference = Duration(seconds: toZone.currentTimeZone.offset - fromZone.currentTimeZone.offset);
    final toTzTime = fromTzTime.toLocal().add(offsetDifference);
